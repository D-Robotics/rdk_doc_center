...
export const STUDIO_CHAPTERS = [
  {
    path: "/product-intro/overview",
    zh: {
      title: "1.1 产品概述",
      parent: "1. 产品简介",
      summary: "RDK Studio 是面向机器人开发的 AI 原生桌面工作台，集成 Moss 对话、项目工作区、设备连接、远程开发、烧录、本地模型和板端 Agent；说明其与传统远程工具的差异及信息整合方式。",
      keywords: ["产品概述", "Moss", "工作台", "AI 原生"],
    },
    en: {
      title: "1.1 Product Overview",
      parent: "1. Product Introduction",
      summary: "RDK Studio is an AI-native desktop workspace for robotics: Moss chat, project workspace, device connection, remote dev, flashing, local models, and on-board Agent—how it differs from traditional remote tools.",
      keywords: ["overview", "Moss", "workspace"],
    },
  },
  {
    path: "/product-intro/architecture",
    zh: {
      title: "1.2 核心架构",
      parent: "1. 产品简介",
      summary: "从桌面客户端、Moss、OpenClaw 三部分说明架构，对比二者适用场景、连接关系及消息处理流程。",
      keywords: ["架构","Moss","OpenClaw","客户端"],
    },
    en: {
      title: "1.2 Core Architecture",
      parent: "1. Product Introduction",
      summary: "Desktop client, Moss, and OpenClaw: roles, when to use each, connectivity, and message flow.",
      keywords: ["architecture","Moss","OpenClaw"],
    },
  },
  {
    path: "/product-intro/feature-matrix",
    zh: {
      title: "1.3 功能入口",
      parent: "1. 产品简介",
  ...
  {
    path: "/product-intro/supported-hardware",
    zh: {
      title: "1.4 支持的硬件",
      parent: "1. 产品简介",
      summary: "说明 RDK X3/X5/S100 的烧录、Type-C 直连、OpenClaw 支持，以及 SSH 接入 Jetson、树莓派等通用 Linux 主机时的能力边界。",
      keywords: ["硬件","X3","X5","S100","Type-C","SSH","Jetson","树莓派"],
    },
    en: {
      title: "1.4 Supported Hardware",
      parent: "1. Product Introduction",
      summary: "RDK X3/X5/S100 flashing, Type-C, OpenClaw; SSH to Jetson, Raspberry Pi and generic Linux limits.",
      keywords: ["hardware","X3","X5","S100","Type-C","SSH"],
    },
  },
  {
    path: "/product-intro/version-notes",
    zh: {
      title: "1.5 版本说明",
      parent: "1. 产品简介",
      summary: "介绍客户端查看/升级、升级注意事项及论坛、反馈等求助渠道。",
      keywords: ["版本", "升级", "论坛", "反馈"],
    },
    en: {
  ...
  {
    path: "/product-intro/ai-showcase",
    zh: {
      title: "1.6 AI Dock 实战演示",
      parent: "1. 产品简介",
      summary: "用三段真实对话展示 AI Dock：设备全量体检、端到端部署 YOLO 并 Web 验证、生成社区发帖草稿。",
      keywords: ["AI Dock","演示","YOLO","体检","实战"],
    },
    en: {
      title: "1.6 AI Dock Showcase",
      parent: "1. Product Introduction",
      summary: "Three real dialogs: full device health check, end-to-end YOLO deploy with web verify, community post draft.",
      keywords: ["AI Dock", "YOLO"],
    },
  },
  {
    path: "/quick-start/install-and-login",
    zh: {
      title: "2.1 安装与登录",
      parent: "2. 快速入门",
      summary: "下载 Windows/macOS 安装包，通过 D-Robotics 统一登录完成首次登录，介绍四步引导流程。",
    ...
    en: {
      ...
      keywords: ["install", "onboarding"],
    },
  },
  {
    path: "/quick-start/flash-system",
    zh: {
      title: "2.2 烧录系统镜像",
      parent: "2. 快速入门",
  ...
  {
    path: "/quick-start/connect-device",
    zh: {
      title: "2.3 接入设备",
      parent: "2. 快速入门",
  ...
  {
    path: "/quick-start/connect-device/typec-flash",
    zh: {
  ...
  {
    path: "/quick-start/connect-device/serial",
    zh: {
      title: "2.3.3 串口日志",
      parent: "2.3 接入设备",
  ...
  {
    path: "/quick-start/configure-network",
    zh: {
      title: "2.4 配置网络",
      parent: "2. 快速入门",
  ...
  {
    path: "/quick-start/configure-ai-model",
    zh: {
      title: "2.5 接入 AI 模型",
      parent: "2. 快速入门",
      summary: "默认模型、团队自建模型、本机 Ollama 三条配置路径，以及思考/快速模式用途。",
      keywords: ["AI 模型", "Ollama", "快速模式"],
    },
    en: {
  ...
  {
    path: "/quick-start/first-conversation",
    zh: {
      title: "2.6 发起首次对话",
      parent: "2. 快速入门",
      summary: "在工作台发送首条消息，说明执行/计划、快速/思考开关及示例提问。",
      keywords: ["首次对话", "执行", "计划", "工作台"],
    },
    en: {
  ...
  {
    path: "/user-guide/workbench/device-status",
    zh: {
      title: "3.1.1 设备状态与诊断",
      parent: "3.1 工作台",
  ...
  {
    path: "/user-guide/workbench/cross-page",
    zh: {
      title: "3.1.2 跨页面联动",
      parent: "3.1 工作台",
  ...
  {
    path: "/user-guide/workbench/offline-cache",
    zh: {
      title: "3.1.3 离线缓存",
      parent: "3.1 工作台",
  ...
  {
    path: "/user-guide/ai-chat/overview-and-entry",
    zh: {
  ...
  {
    path: "/user-guide/ai-chat/device-aware-tools",
    zh: {
      title: "3.2.2 设备操作与结果",
      parent: "3.2 AI Dock",
  ...
  {
    path: "/user-guide/ai-chat/multi-session",
    zh: {
      title: "3.2.3 查看历史会话",
      parent: "3.2 AI Dock",
  ...
  {
    path: "/user-guide/ai-chat/attachments",
    zh: {
      title: "3.2.4 上传文件和截图",
      parent: "3.2 AI Dock",
  ...
  {
    path: "/user-guide/ai-chat/slash-commands",
    zh: {
      title: "3.2.5 使用快捷命令",
      parent: "3.2 AI Dock",
  ...
  {
    path: "/user-guide/ai-chat/dual-lane",
    zh: {
      title: "3.2.6 选择回复模式",
      parent: "3.2 AI Dock",
  ...
  {
    path: "/user-guide/remote-terminal",
    zh: {
      title: "3.3 终端",
      parent: "3. 用户指南",
  ...
  {
    path: "/user-guide/remote-terminal/multi-tab-ssh",
    zh: {
  ...
  {
    path: "/user-guide/remote-terminal/reconnect",
    zh: {
      title: "3.3.2 断线重连",
      parent: "3.3 终端",
  ...
  {
    path: "/user-guide/remote-terminal/serial",
    zh: {
      title: "3.3.3 查看串口日志",
      parent: "3.3 终端",
  ...
  {
    path: "/user-guide/file-manager/browse-and-transfer",
    zh: {
      title: "3.4.1 浏览和传文件",
      parent: "3.4 文件",
  ...
  {
    path: "/user-guide/file-manager/online-edit",
    zh: {
      title: "3.4.2 编辑文件",
      parent: "3.4 文件",
  ...
  {
    path: "/user-guide/file-manager/path-access-control",
    zh: {
      title: "3.4.3 哪些路径不能改",
      parent: "3.4 文件",
      summary: "`/sys`、`/proc`、`/dev`、`/boot` 等受限路径及例外授权方式。",
      keywords: ["/sys", "/proc", "受限路径"],
    },
    en: {
  ...
  {
    path: "/user-guide/remote-ide/install-and-init",
    zh: {
      title: "3.5.1 打开代码编辑器",
      parent: "3.5 代码编辑器",
  ...
  {
    path: "/user-guide/remote-ide/system-requirements",
    zh: {
      title: "3.5.2 准备编辑环境",
      parent: "3.5 代码编辑器",
  ...
  {
    path: "/user-guide/remote-ide/floating-window",
    zh: {
      title: "3.5.3 弹出编辑器窗口",
      parent: "3.5 代码编辑器",
  ...
  {
    path: "/user-guide/remote-desktop",
    zh: {
      title: "3.6 远程桌面",
      parent: "3. 用户指南",
      summary: "在 Studio 内查看/操作板端图形界面的流程及 ROS 调试、摄像头预览等场景。",
      keywords: ["远程桌面", "图形界面", "ROS"],
    },
    en: {
  ...
  {
    path: "/user-guide/remote-desktop/startup-auth",
    zh: {
      title: "3.6.1 打开远程桌面",
      parent: "3.6 远程桌面",
  ...
  {
    path: "/user-guide/remote-desktop/performance-tuning",
    zh: {
  ...
  {
    path: "/user-guide/remote-desktop/alternatives",
    zh: {
      title: "3.6.3 其他远程方式",
      parent: "3.6 远程桌面",
  ...
  {
    path: "/user-guide/system-flashing",
    zh: {
      title: "3.7 烧录",
      parent: "3. 用户指南",
  ...
  {
    path: "/user-guide/system-flashing/media-comparison",
    zh: {
      title: "3.7.1 选择烧录方式",
      parent: "3.7 烧录",
      summary: "TF 卡、eMMC、S100 三种入口对比及 TF 卡选购建议。",
      keywords: ["eMMC", "S100", "烧录方式"],
    },
    en: {
  ...
  {
    path: "/user-guide/system-flashing/tf-card",
    zh: {
      title: "3.7.2 TF 卡烧录",
      parent: "3.7 烧录",
  ...
  {
    path: "/user-guide/system-flashing/emmc",
    zh: {
      title: "3.7.3 eMMC 烧录",
      parent: "3.7 烧录",
  ...
  {
    path: "/user-guide/system-flashing/s100-xburn",
    zh: {
      title: "3.7.4 S100 烧录",
      parent: "3.7 烧录",
  ...
  {
    path: "/user-guide/network-config",
    zh: {
      title: "3.8 网络配置",
      parent: "3. 用户指南",
  ...
  {
    path: "/user-guide/network-config/entry-and-status",
    zh: {
  ...
  {
    path: "/user-guide/network-config/hidden-ssid",
    zh: {
  ...
  {
    path: "/user-guide/network-config/persistence",
    zh: {
  ...
  {
    path: "/user-guide/device-management",
    zh: {
      title: "3.9 设备管理",
      parent: "3. 用户指南",
  ...
  {
    path: "/user-guide/device-management/list-and-switch",
    zh: {
      title: "3.9.1 切换当前设备",
      parent: "3.9 设备管理",
  ...
  {
    path: "/user-guide/device-management/auto-detect",
    zh: {
      title: "3.9.2 自动识别设备",
      parent: "3.9 设备管理",
  ...
  {
    path: "/user-guide/device-management/online-monitoring",
    zh: {
      title: "3.9.3 查看在线状态",
      parent: "3.9 设备管理",
  ...
  {
    path: "/user-guide/openclaw/overview",
    zh: {
  ...
  {
    path: "/user-guide/openclaw/deploy-uninstall",
    zh: {
      title: "3.10.2 部署和卸载",
      parent: "3.10 OpenClaw",
  ...
  {
    path: "/user-guide/openclaw/main-panel",
    zh: {
  ...
  {
    path: "/user-guide/openclaw/collab-with-dmoss",
    zh: {
  ...
  {
    path: "/user-guide/openclaw/task-delegation",
    zh: {
      title: "3.10.5 处理板端任务",
      parent: "3.10 OpenClaw",
  ...
  {
    path: "/user-guide/openclaw/pairing-security",
    zh: {
      title: "3.10.6 配对和确认",
      parent: "3.10 OpenClaw",
  ...
  {
    path: "/user-guide/skill/skill-md-structure",
    zh: {
  ...
  {
    path: "/user-guide/skill/builtin-skills",
    zh: {
      title: "3.11.2 查看内置技能",
      parent: "3.11 技能工坊",
  ...
  {
    path: "/user-guide/skill/clawhub-community",
    zh: {
      title: "3.11.3 查找技能",
      parent: "3.11 技能工坊",
  ...
  {
    path: "/user-guide/skill/create-and-import",
    zh: {
      title: "3.11.4 创建技能",
      parent: "3.11 技能工坊",
  ...
  {
    path: "/user-guide/skill/trigger-matching",
    zh: {
      title: "3.11.5 设置触发词",
      parent: "3.11 技能工坊",
  ...
  {
    path: "/user-guide/skill/sync-to-board",
    zh: {
      title: "3.11.6 同步到设备",
      parent: "3.11 技能工坊",
  ...
  {
    path: "/user-guide/config-center/overview",
    zh: {
      title: "3.13.1 看懂设置页",
      parent: "3.13 配置中心",
  ...
  {
    path: "/user-guide/config-center/account",
    zh: {
      title: "3.13.2 登录账号",
      parent: "3.13 配置中心",
  ...
  {
    path: "/user-guide/config-center/ai-engine",
    zh: {
  ...
  {
    path: "/user-guide/config-center/device-defaults",
    zh: {
      title: "3.13.4 设置设备连接",
      parent: "3.13 配置中心",
  ...
  {
    path: "/user-guide/config-center/import-export",
    zh: {
      title: "3.13.5 导入导出配置",
      parent: "3.13 配置中心",
  ...
  {
    path: "/user-guide/channels/feishu",
    zh: {
      title: "3.14.1 接入飞书",
      parent: "3.14 消息渠道",
  ...
  {
    path: "/user-guide/channels/weixin",
    zh: {
      title: "3.14.2 接入微信",
      parent: "3.14 消息渠道",
  ...
  {
    path: "/user-guide/channels/security",
    zh: {
  ...
  },
  {
    ...
    en: {
      ...
      keywords: ["monitoring", "token"],
    },
  },
  {
    path: "/user-guide/monitoring/task-queue",
    zh: {
      title: "3.15.1 查看任务进度",
      parent: "3.15 监控与运维",
  ...
  {
    path: "/user-guide/monitoring/token-usage",
    zh: {
  ...
  {
    path: "/user-guide/cli/dmoss-agent",
    zh: {
  ...
  {
    path: "/user-guide/cli/automation-examples",
    zh: {
      title: "3.16.3 自动化示例",
      parent: "3.16 命令行",
  ...
  {
    path: "/faq/openclaw-install-failed",
    zh: {
  ...
  {
    path: "/faq/model-quality",
    zh: {
      title: "5.11 模型回答质量问题",
      parent: "5. 常见问题",
      summary: "跑题、重复、工具选错、thinking 暴露、中英混杂等排查清单。",
      keywords: ["回答", "thinking"],
    },
    en: {
